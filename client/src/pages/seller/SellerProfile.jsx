...
const SellerProfile = () => {
  ...
  const handleAddressSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success('Shop address saved successfully!')
        dispatch(updateUser(response.data.user))
  ...
  return (
    <div className="container-fluid">
      <h4 className="mb-4 fw-semibold">Seller Profile</h4>
      ...
      {(!user?.address || !user?.address?.street) && (
        <div className="alert alert-warning d-flex align-items-center mb-4">
          ...
          <div>
            <strong>Shop Address Missing!</strong> Please add your shop address for customers and delivery.
          </div>
        </div>
      )}
              ...
              <Form onSubmit={handleProfileSubmit}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    className="bg-light"
                  />
                  <Form.Text className="text-muted">Business name cannot be changed</Form.Text>
                </Form.Group>
        ...
        <div className="col-lg-6">
          <Card className="border-0 shadow-sm h-100">
            <Card.Header className="bg-transparent py-3 d-flex justify-content-between align-items-center">
              <h5 className="mb-0 fw-semibold">Shop Address</h5>
              <Button 
            ...
            <Card.Body>
              {user?.address && user?.address?.street ? (
                <div className="border rounded p-4">
                  <div className="d-flex align-items-start gap-3">
                    ...
                    <div>
                      <h6 className="mb-1">Shop Location</h6>
                ...
                <div className="text-center py-5">
                  ...
                  <p className="text-muted mb-3">No shop address saved yet</p>
                  <Button 
                    variant="primary" 
                    size="sm"
                    onClick={() => setShowAddressModal(true)}
              ...
              <div className="alert alert-info mt-4 mb-0 small">
                ...
                Your shop address is used for delivery pickup. Customers will also see this location.
              </div>
            </Card.Body>
          </Card>
        </div>
      ...
      >
        <Modal.Header closeButton={!addressRequired}>
          <Modal.Title>
            ...
            {user?.address?.street ? 'Update Shop Address' : 'Add Shop Address'}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {addressRequired && (
            <div className="alert alert-warning mb-3">
              <strong>Shop Address Required!</strong><br />
              Please add your shop address for delivery pickup and customer visibility.
            </div>
          )}
          <Form onSubmit={handleAddressSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                placeholder="Enter shop street address"
            ...
            <div className="d-flex gap-2">
              ...
              <Button 
                ...
                className="flex-grow-1"
              >
                {loading ? 'Saving...' : 'Save Shop Address'}
              </Button>
            </div>
          </Form>
        </Modal.Body>
