...
const DeliveryProfile = () => {
  ...
  return (
    <div className="container-fluid">
      <h4 className="mb-4 fw-semibold">Delivery Partner Profile</h4>
      ...
      {(!user?.address || !user?.address?.street) && (
        <div className="alert alert-warning d-flex align-items-center mb-4">
          ...
          <div>
            <strong>Profile Incomplete!</strong> Please add your address to receive delivery assignments in your area.
          </div>
        </div>
      )}
                    ...
                    >
                      {preview ? (
                        ...
                        <div className="w-100 h-100 bg-light d-flex align-items-center justify-content-center">
                          <i className="fas fa-motorcycle fa-3x text-muted"></i>
                        </div>
                      )}
                    </div>
                    <label 
        ...
        <div className="col-lg-6">
          <Card className="border-0 shadow-sm h-100">
            <Card.Header className="bg-transparent py-3 d-flex justify-content-between align-items-center">
              <h5 className="mb-0 fw-semibold">Home Address</h5>
              <Button 
            ...
            <Card.Body>
              ...
              <div className="alert alert-info mt-4 mb-0 small">
                ...
                Your address helps us assign deliveries near your location for faster pickups.
              </div>
            </Card.Body>
          </Card>
        </div>
        ...
        <Modal.Body>
          {addressRequired && (
            <div className="alert alert-warning mb-3">
              ...
              Please add your address to receive delivery assignments in your area.
            </div>
          )}
